...
export default function PostCard({ post }) {
  ...
  return (
    ...
    >
      <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden transition-all duration-300 hover:shadow-lg hover:border-indigo-200 hover:-translate-y-1">
        {/* Image Banner */}
        {images.length > 0 && (
        ...
        <div className="p-6">
          ...
          {/* Read More Button */}
          <div className="flex items-center gap-2 text-indigo-600 font-semibold text-sm group/btn">
            <span>Chi tiết</span>
