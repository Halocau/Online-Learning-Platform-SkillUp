// src/pages/contentmoderator/CourseManage.jsx
...
export default function CourseManagement() {
  ...
  const [publishTab, setPublishTab] = useState("public"); // "public", "pending", "unpublish", "reports"
          ...
          <>
            ...
            <div className="bg-white p-4 shadow-sm">
              ...
              <div className="mt-3 text-sm text-gray-600">
                Đang hiện {paginatedCourses.length} / {sortedCourses.length}{" "}
                khóa học
              </div>
            </div>
