...
function Unauthorized() {
  ...
  const translateRole = (role) => {
    switch (role) {
      case "Admin":
        return "Quản trị viện";
      case "Content Morderator":
        return "Chuyên viên chất lượng";
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-red-50 to-orange-50">
      <div className="max-w-md w-full px-6">
        <div className="bg-white rounded-2xl shadow-2xl p-8 text-center border-4 border-red-800 border-double">
          {/* Icon */}
          ...
          {/* Role Info */}
          {userRole && (
            <div className="bg-gray-50 rounded-lg p-4 mb-6 border-2 border-yellow-500">
