...
namespace SkillUp.Repositories.Implementations
{
	public class QuizSubmissionRepository : IQuizSubmissionRepository
	{
		...
		public async Task<List<QuizSubmission>> GetQuestionBanksInSubmission(Guid questionBankId)
		{
			return await _context.QuizSubmissions
				.Include(qs => qs.QuizAnswerSubmissions)         
					.ThenInclude(qas => qas.QuestionBank)        
				.Where(qs => qs.QuizAnswerSubmissions.Any(qas => qas.QuestionBankId == questionBankId))
				.ToListAsync();
		}
	}
}
